...
public class ContentBundleFunctionalTestCases extends BaseTest{
	...
	String jsonCreateValidContent = "{\"request\": {\"content\": {\"identifier\": \"LP_FT_"+rn+"\",\"osId\": \"org.ekstep.quiz.app\", \"mediaType\": \"content\",\"visibility\": \"Default\",\"description\": \"Test_QA\",\"name\": \"LP_FT_"+rn+"\",\"language\":[\"English\"],\"contentType\": \"Resource\",\"code\": \"Test_QA\",\"mimeType\": \"application/vnd.ekstep.ecml-archive\",\"pkgVersion\": 3,\"tags\":[\"LP_functionalTest\"], \"owner\": \"EkStep\"}}}";
	...
	public void bundleECMLAndAPKContentsExpectSuccess200(){
		...
		while(count<=2){
			...
			if(count==2){
				js.getJSONObject("request").getJSONObject("content").put("identifier", "LP_FT_T_"+rn+"").put("name", "LP_FT_T-"+rn+"").put("osId", "org.ekstep.aser").put("mimeType", "application/vnd.android.package-archive");
			}
			String jsonCreateValidChild = js.toString();
			Response R =
					given().
